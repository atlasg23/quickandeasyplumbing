...
const Home: NextPage = () => {
  ...
  return (
    <div className={styles.container}>
      ...
      {/* Services Section - Design Option 1: Modern Grid Cards */}
      <section id="services" className={styles.servicesSection}>
        <div className={styles.servicesContainer}>
          <h2 className={styles.servicesTitle}>Design Option 1: Modern Grid Cards</h2>
      ...
      {/* Services Section - Design Option 2: Minimalist List Style */}
      <section className={`${styles.servicesSection} ${styles.servicesSection2}`}>
        <div className={styles.servicesContainer}>
          <h2 className={styles.servicesTitle}>Design Option 2: Minimalist List</h2>
          <p className={styles.servicesSubtitle}>Clean and professional service overview</p>
          
          <div className={`${styles.servicesGrid} ${styles.servicesGrid2}`}>
      ...
      {/* Services Section - Design Option 3: Dark Theme with Glowing Cards */}
      <section className={`${styles.servicesSection} ${styles.servicesSection3}`}>
        <div className={styles.servicesContainer}>
          <h2 className={`${styles.servicesTitle} ${styles.servicesTitle3}`}>Design Option 3: Dark Glow Theme</h2>
          <p className={`${styles.servicesSubtitle} ${styles.servicesSubtitle3}`}>Modern dark theme with glowing effects</p>
